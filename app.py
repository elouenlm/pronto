...
with tab5:
    ...
    with col1:
        import os
        for img_p in ["LADIQ_framework.png", "stream/courbe_ale_ips_pure_1_.png"]:
            if os.path.exists(img_p) and "framework" in img_p.lower():
                st.image(img_p, caption="Framework LADIQ (Learning Analytics Data Quality Framework)", use_container_width=True)
                break
