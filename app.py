...
with st.sidebar:
    ...
    <div style='font-size: 0.72rem; color: #8b949e; line-height: 1.6;'>
        ...
        <b style='color: #c9d1d9;'>Données :</b> Synthétiques, inspirées DEPP 2022–2024<br>
...
with tab2:
    ...
    with col1:
        ...
        fig_comp.update_layout(**PLOTLY_THEME, height=320,
                       yaxis=dict(range=[88, 101.5], gridcolor='#21262d', title='Complétude (%)'),
...
with tab3:
    ...
    with col1:
        ...
        fig_imp.update_layout(**PLOTLY_THEME, height=200,
                              xaxis=dict(range=[0, 0.95], tickformat='%', gridcolor='#21262d'),
                              xaxis_title='Importance relative', legend=LEGEND_DEFAULT)
...
with tab4:
    ...
    with col1:
        ...
        fig_reg = go.Figure(go.Bar(
            ...
            marker=dict(
                ...
                showscale=True,
                colorbar=dict(title='IPS', thickness=12, len=0.7,
    ...
    with col2:
        ...
        fig_bubble.update_coloraxes(colorbar=dict(
            title='Taux réussite', thickness=12,
            tickfont=dict(color='#8b949e'), titlefont=dict(color='#8b949e'),
        ))
